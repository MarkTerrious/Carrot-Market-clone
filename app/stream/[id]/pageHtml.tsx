...
import { LiveStreamType } from "./page";
import { notFound } from "next/navigation";
import { UserIcon } from "@heroicons/react/24/solid";
import { SESSION_ID_TYPE } from "@/api/session";

interface LiveStreamInterface {
    stream: LiveStreamType,
    userId: SESSION_ID_TYPE
}

export default function LiveStreamingHtml({
    stream,
    userId,
} : LiveStreamInterface)
{
    ...
    return (
        <div className="p-10">
            <div className="relative aspect-video">
                <iframe
                    src={`https://${process.env.CLOUDFLARE_API_DOMAIN}/${stream.stream_id}/iframe`}
